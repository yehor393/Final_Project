    ...
    for request in commands:  # dict with commands
        if user_input.startswith(request):
            ...
            if func == add_contact:
                ...
                name = name_input()
                info_to_amend = input('what type of information will be amended (phone / birthday / email / address / '
                                      'note): ')
                ...
                elif (info_to_amend != 'phone' and info_to_amend != 'birthday' and info_to_amend != 'email'
                      and info_to_amend != 'address' and info_to_amend != 'note'):
            ...
            # run func which don't need args. hello, help, show all
            else:
                return func()
