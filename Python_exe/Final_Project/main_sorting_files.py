...
def main(folder_path):
    ...
    categories = [
        ...
        ("Documents", Final_Project.scan.documents_files),
        ("Audio", Final_Project.scan.audio_files),
        ("Video", Final_Project.scan.video_files),
        ("Others", Final_Project.scan.others),
        ("Unknown", Final_Project.scan.unknown),
    ]
    ...
    if Final_Project.scan.archives_files:
        with tqdm(total=len(Final_Project.scan.archives_files), desc="Processing Archives") as pbar:
